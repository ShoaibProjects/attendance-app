...
const ZOOM_WEBHOOK_SECRET_TOKEN =
  process.env.ZOOM_WEBHOOK_SECRET_TOKEN || "YOUR_WEBHOOK_SECRET_TOKEN"; // This is crucial for webhook validation
...
router.post("/webhook", async (req: Request, res: Response) => {
  ...
  if (event === "meeting.ended") {
    ...
    try {
      ...
      console.error(
        "Error fetching participants or saving attendance:",
        err.message
      );
