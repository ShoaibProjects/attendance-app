...
export default function LoginForm() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-8 relative overflow-hidden">
      ...
      >
        <motion.div
          className="bg-slate-800/80 backdrop-blur-xl shadow-2xl rounded-2xl p-8 border border-slate-700/50 relative overflow-hidden"
        ...
        >
          ...
          <div className="relative z-10">
            ...
            >
              <motion.div 
                className="inline-flex items-center justify-center w-16 h-16 bg-sky-500/10 rounded-full mb-4"
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <motion.div variants={itemVariants}>
                <motion.button
                  type="submit"
                  disabled={loading}
                  className="w-full mt-2 bg-gradient-to-r from-sky-600 to-sky-500 hover:from-sky-500 hover:to-sky-400 text-white py-3 px-4 rounded-lg font-semibold transition-all duration-300 shadow-lg hover:shadow-sky-500/30 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  whileHover={{ 
            ...
            <motion.p 
              ...
              variants={itemVariants}
            >
              Secure login powered by ClassTrack
            </motion.p>
          </div>
        </motion.div>
      </motion.div>
